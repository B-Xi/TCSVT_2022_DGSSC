...
--
Please run the 'main.py' to reproduce the DGSSC results on [Lokia](http://www.ehu.eus/ccwintco/index.php?title=Hyperspectral_Remote_Sensing_Scenes#Pavia_University_scene) dataset. 
